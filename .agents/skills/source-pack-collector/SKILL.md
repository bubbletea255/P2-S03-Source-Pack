...
description: Source Pack v2의 Codex collector adapter. 미국 상장 주식 한 회사의 SEC 공시, IR 자료, 가능한 경우 transcript 원문을 raw 파일로 저장하고 catalog 원장과 회사별 index.md를 갱신할 때 사용한다. 공통 원장인 harness/ 계약, 절차, schema, rubric을 따른다.
---

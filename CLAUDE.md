...
| 2026-06-05 | Source Pack v15 TEM IR pilot 완료 — ir-taxonomy-candidates.jsonl TEM 후보 1건(ir-earnings-presentation, needs_review), run-20260605-tem-ir-pilot 실행 산출물 신규, .gitignore session-checkpoints 추가 |
| 2026-06-06 | Source Pack v16 Global Harness Template v5 Phase 1~3.5 롤백 지점 — docs 폴더 구조 재편(current/design/handoff/pilots/reference/templates/), global-harness-core-structure-template-v1 신규, design-preflight-template-v0 module 신규, v5 core 범위 합의·gap analysis·extraction note·work-map·Phase 1~3.5 review note 완성, source-command adapter 개선, .claude/commands/저장.md 전역 skill로 이전 |
| 2026-06-07 | Source Pack v17 Global Harness Template v5 Phase 6 완료 + Phase 7 사전 합의 롤백 지점 — Phase 4 hook cross-check 완료, Phase 5 registry·path·pilot-first 의사결정 5종, Phase 6 module v1 7종(approval-gate/candidate-ledger/checkpoint/docs-organization/observability/qa-scaffold/security-baseline) + scope note 6종 + diagnostic·deep-review note 2종, core registry 개념 흐름 기준 재정렬, Phase 7 planning consensus note(Claude PASS) — Phase 7 구조(7-0/A/B/C) 합의, signal-routing v0 Phase 7 첫 작업 합의, 전역 배포 Phase 7-B 이후 판단 합의, Q1·Q2: 다음 pilot = Step 4 Industry Primer(분석 준비형), Earnings Call = Step 3-2 분리 후보 합의, docs/reference 가치투자 21단계 MD 추가 |
| 2026-06-14 | Source Pack v18 S04 Industry Primer 이전 완료 롤백 지점 — APP top-up 실행 지도·handoff item_id preflight 신규, Phase 0 설계 합의 보존, Phase 1 APP latest 10-K/10-Q/sector metadata SEC top-up 완료(run-20260614-app-sec-sector-topup, QA pass) |
| 2026-06-14 | Source Pack v19 APP company-official Phase 3 harness 수정안 완성 롤백 지점 — company-official-phase3-harness-change-proposal-2026-06-14.md 신규(catalog.schema/collector/runbook/QA 수정안, harness 미반영), 실행 지도 Phase 3 in_progress 갱신 |

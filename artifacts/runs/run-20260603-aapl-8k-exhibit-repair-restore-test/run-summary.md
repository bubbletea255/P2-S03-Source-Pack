...
- 대상 티커: AAPL
- run-id: run-20260603-aapl-8k-exhibit-repair-restore-test
...
| AAPL | download log | artifacts/runs/run-20260603-aapl-8k-exhibit-repair-restore-test/download-log.jsonl |
| AAPL | QA | artifacts/runs/run-20260603-aapl-8k-exhibit-repair-restore-test/qa.md |

## 실패와 확인 필요
| 티커 | 항목 | 상태 | 이유 | 권장 조치 |
|---|---|---|---|---|
| AAPL | repair_required 복구 확인 | 성공 | EX-99.1 local_path가 복구되어 fast path 통과 | 다음 단계 진행 가능 |
| AAPL | 전체 Source Pack 범위 | 확인 필요 | test_collection은 최신 8-K Item 2.02 EX-99.1 복구 확인만 검증 | 전체 수집은 별도 new_collection으로 실행 |

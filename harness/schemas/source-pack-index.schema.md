...
주요 품질 축: `출처 추적성`, `누락 관리`, `표 형식 안정성`, `다음 하네스 전달성`

이 schema는 분석 리포트가 아니라 다음 하네스가 읽을 원자료 인덱스 형식을 정의한다.
원자료 내용의 해석, 투자 thesis, 밸류에이션, 매수/매도 판단은 이 schema에 넣지 않는다.
품질 기준은 해석의 깊이가 아니라 출처 추적성, 누락 관리, 표 형식 안정성, 다음 하네스 전달성이다.
